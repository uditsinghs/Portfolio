...
export const updatePassword = ( currentPassword, newPassword, confirmNewPassword) =async(dispatch)=>{
  ...
  try {
    const {data} = await axios.put("http://localhost:3000/api/v1/user/update/password",{currentPassword, newPassword, confirmNewPassword},{
      withCredentials:true ,
      headers:{"Content-Type":"application/json"},
    })
...
export const updateProfile = (data) =async(dispatch)=>{
  ...
  try {
    const {data} = await axios.put("http://localhost:3000/api/v1/user/update/me",data,{
      withCredentials:true ,
